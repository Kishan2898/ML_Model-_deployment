...
# Load Data
dataset = pd.read_csv(r'C:\Users\kksah\VS code\Classroom\Classwork\CICD\cicd_Github_Action-main\cicd_Github_Action-main\iris.csv')
...
# Logistic Regression
logreg = LogisticRegression(C=0.0001, solver='lbfgs', max_iter=1000)
